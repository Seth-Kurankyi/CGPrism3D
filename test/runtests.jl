...
run = 10
Kt = 4
FinAmp = InitialLoop(dataT,Kt)
@show length(FinAmp[2])
@show sum(FinAmp[2])
# for i in 1:run
#     global FinAmp = LoopFunction(FinAmp,Kt)
#     @show length(FinAmp[2])
#     @show sum(FinAmp[2])
# end

println(275.6467529817264) #SumAmpK_2


# @time CGPrsmA1 = temp(dataT)
# @show sum(CGPrsmA1[2][2])
